          ...
          <div>
            {total > 30 ? (
              <div className="data_bmi">
                ...
                <h2>
                  A better approach: Adopt habits that will help you avoid
                  overeating and skip some of the high-calorie, low-nutrient
                  foods that are most strongly linked to weight gain, such as
                  sugar-sweetened beverages, refined grains, and potatoes.
                </h2>
                <br></br>
                <h2>
                  Besides eating a healthy diet, nothing is more important to
                  keeping weight in check and staying healthy than regular
                  activity. If there ever were a magic bullet for good health,
                  physical activity would be it. How much activity is
                  recommended depends on whether you’re a child or an adult and
                  what your goals are: good health or weight control. There are
                  a lot of ways to get moving. Choose activities you enjoy.
                </h2>
              </div>
            ) : (
              <div></div>
